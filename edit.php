                    ...
                    if ($d = mysqli_fetch_array($karyawanQuery)) {
                        ...
                        <form method="post" action="update.php">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="id_kar" value="<?php echo $d['id_kar']; ?>"
                                    readonly>
                            </div>
                            <div class="form-group">
                                <label>Nama</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="no_induk"
                                    value="<?php echo $d['no_induk']; ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="id_jab">Jabatan</label>
                                <select name="id_jab" id="id_jab" class="form-control" required>
                                    <option
                                        value="<?php echo isset($jabatanData['id_jab']) ? $jabatanData['id_jab'] : ''; ?>">
